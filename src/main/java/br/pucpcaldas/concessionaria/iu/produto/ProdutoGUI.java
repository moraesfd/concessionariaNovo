...
public class ProdutoGUI extends JFrame {
		...
		if (bNovo == null) {
			...
			bNovo.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					CadastroProdutoGUI cadastroGui = new CadastroProdutoGUI();
	...
	private JTable getTProdutos() {
		if (tProdutos == null) {
			...
			tProdutos = controlador.getTabelaProdutos();
			tProdutos.setFont(new Font("Dialog", Font.PLAIN, 14));
			tProdutos.setRowHeight(20);
		}
		return tProdutos;
	}
