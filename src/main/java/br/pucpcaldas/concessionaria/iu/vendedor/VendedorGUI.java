...
public class VendedorGUI extends JFrame {
	...
	private JScrollPane spVendedor = null;
	private JTable tVendedor = null;
	...
	private JPanel getPCentro() {
		if (pCentro == null) {
			...
			pCentro.add(getSpVendedor(), gridBagConstraints4);
		}
		return pCentro;
	}
		...
		if (bNovo == null) {
			...
			bNovo.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					CadastroVendedorGUI cadastroGui = new CadastroVendedorGUI();
	...
	/**
	 * This method initializes spVendedor	
	 * 	
	 * @return javax.swing.JScrollPane	
	 */
	private JScrollPane getSpVendedor() {
		if (spVendedor == null) {
			spVendedor = new JScrollPane();
			spVendedor.setViewportView(getTVendedor());
		}
		return spVendedor;
	}
	 ...
	 */
	private JTable getTVendedor() {
		if (tVendedor == null) {
			tVendedor = controlador.getTabelaVendedores();
			tVendedor.setFont(new Font("Dialog", Font.PLAIN, 14));
			tVendedor.setRowHeight(20);
		}
		return tVendedor;
	}
